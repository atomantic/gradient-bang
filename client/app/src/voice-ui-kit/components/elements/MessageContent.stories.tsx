...
export const MessageContentDefault: Story<{
  ...
  return (
    <div className="ladle-section-container">
      ...
      <section className="ladle-section">
        <MessageContent message={createSampleMessage("user", "Hello, can you help me?")} />
        <MessageContent
          message={createSampleMessage("assistant", "Of course! I'd be happy to help you.")}
        />
        <MessageContent message={createSampleMessage("system", "System: Conversation started")} />
      </section>
      ...
      <section className="ladle-section">
        <MessageContent
          ...
          classNames={{
            messageContent: "bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400",
