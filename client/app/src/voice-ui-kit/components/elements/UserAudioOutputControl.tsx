 ...
 */
export interface UserAudioOutputControlBaseProps extends Omit<SelectTriggerProps, "children"> {
 ...
 */
export interface UserAudioOutputControlComponentProps extends UserAudioOutputControlBaseProps {
...
export const UserAudioOutputControlComponent = ({
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <Select value={selectedValue} onValueChange={(v) => updateDevice?.(v)} {...selectProps}>
        <SelectTrigger
          id={id}
        ...
        >
          {guide ?
            <SelectGuide>{guide}</SelectGuide>
          : null}
          <SelectValue placeholder={placeholder} />
        </SelectTrigger>
        <SelectContent className={cn(classNames?.selectContent)} align="end" {...contentProps}>
 ...
 * ```
 */
export const UserAudioOutputControl: React.FC<UserAudioOutputControlBaseProps> = (props) => {
