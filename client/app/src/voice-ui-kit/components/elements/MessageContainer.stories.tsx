...
export const MessageContainerDefault: Story<{
  ...
  return (
    <div className="ladle-section-container">
      ...
      <section className="ladle-section">
        <MessageContainer message={createSampleMessage("user", "Hello, can you help me?")} />
        <MessageContainer
          message={createSampleMessage("assistant", "Of course! I'd be happy to help you.")}
        />
        <MessageContainer message={createSampleMessage("system", "System: Conversation started")} />
      </section>
      ...
      <section className="ladle-section">
        <MessageContainer message={createSampleMessage("user", "Hello!")} clientLabel="Customer" />
        <MessageContainer
      ...
      <section className="ladle-section">
        <MessageContainer
          message={createSampleMessage("assistant", "This message has custom styling")}
          classNames={{
      ...
      <section className="ladle-section">
        <div>
          ...
          <MessageContainer
            message={createSampleMessage("assistant", "Hi there! How can I help?")}
          />
          <MessageContainer message={createSampleMessage("user", "Can you explain something?")} />
          <MessageContainer message={createMultiPartMessage()} />
          <MessageContainer message={createSampleMessage("system", "Conversation ended")} />
        </div>
      </section>
    </div>
  )
