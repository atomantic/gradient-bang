import type { ButtonSize, ButtonState, ButtonVariant } from "@/components/ui/buttonVariants"
import { buttonSizeOptions, buttonVariantOptions } from "@/components/ui/buttonVariants"
import { Card, CardContent } from "@/components/ui/card"
import type { Story, StoryDefault } from "@ladle/react"
import { PipecatClient } from "@pipecat-ai/client-js"
import { type OptionalMediaDeviceInfo, PipecatClientProvider } from "@pipecat-ai/client-react"
...
export const Connected: Story<{
  ...
  size: ButtonSize
  state: ButtonState
}> = ({ variant, size, state }) => <UserVideoControl variant={variant} size={size} state={state} />
