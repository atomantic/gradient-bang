  ...
  return (
    <span
      className={cn(
        ...
        {
          "text-active": transportState === "connected" || transportState === "ready",
          "text-destructive": transportState === "error",
          "text-subtle/50 dark:text-subtle/80": transportState === "disconnected",
    ...
    >
      ...
      {transportState &&
        ["authenticating", "authenticated", "connecting"].includes(transportState) && (
