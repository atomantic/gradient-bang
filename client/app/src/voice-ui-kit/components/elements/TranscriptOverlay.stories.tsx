...
export const Basic: Story<{
  ...
  <TranscriptOverlayComponent
    words={["Hello", "my", "name", "is", "ChatBot.", "How", "are", "you", "today?"]}
    size={size}
...
export const WordByWordAnimation: Story<{
  ...
  const fullText = "This demonstrates the word-by-word fade-in animation effect"
    ...
    <div className="space-y-4">
      ...
      <div className="min-h-[100px] flex items-center justify-center">
        {currentWords.length > 0 ?
          ...
          />
        : <p className="text-gray-500 text-sm">
            Click "Start Word-by-Word Animation" to see each word fade in individually
          </p>
        }
      </div>
    </div>
...
export const MultilineBackground: Story<{
  ...
  <div className="space-y-4">
    <p className="text-sm text-gray-600">
      This story tests how the background wraps around multiple lines of text. The background should
      wrap around each line individually, not fill the entire container.
    </p>
