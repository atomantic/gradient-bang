          ...
          <PanelContent className="p-0! overflow-hidden h-full">
            {!noConversation && (
              <TabsContent value="conversation" className="overflow-hidden h-full">
                <Conversation
                  {...conversationElementProps}
                  noTextInput={conversationElementProps?.noTextInput ?? noTextInput}
                  noFunctionCalls={conversationElementProps?.noFunctionCalls ?? noFunctionCalls}
                  botOutputRenderers={conversationElementProps?.botOutputRenderers}
                />
              </TabsContent>
            )}
            {!noMetrics && (
