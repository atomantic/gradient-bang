...
import { PipecatClientVideo, usePipecatClientMediaTrack } from "@pipecat-ai/client-react"
...
export const BotVideoPanel: React.FC<BotVideoPanelProps> = ({ className, collapsed = false }) => {
    ...
    >
      ...
      >
        ...
        : <div className="text-subtle flex w-full h-full gap-2 items-center justify-center">
            ...
            {!collapsed && <span className="font-semibold text-sm">No video</span>}
          </div>
        }
      </PanelContent>
    </Panel>
