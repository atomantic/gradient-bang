...
export const Default: Story<LEDProps> = ({ ...props }) => {
  ...
  return (
    <div className="ladle-section-container">
      ...
      <section className="ladle-section items-center gap-6">
        <LED {...props} classNames={{ on: "bg-emerald-500", off: "bg-neutral-500" }} />
        <LED {...props} className="size-10" classNames={{ on: "bg-red-500", off: "bg-blue-500" }} />
      </section>
      ...
      <section className="ladle-section items-center gap-4">
        ...
        <Button onClick={() => setIsOn((v) => !v)}>Toggle On ({String(isOn)})</Button>
