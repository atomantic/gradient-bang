  ...
  "text-card-foreground flex flex-col bg-card border-(length:--border-width-element) border-border",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        className: "border border-transparent bg-origin-border borderclip bg-cardGradientBorder",
      },
    ],
...
export function CardHeader({ className, ...props }: CardHeaderProps) {
  return <div data-slot="card-header" className={cn("flex gap-1.5", className)} {...props} />
}
