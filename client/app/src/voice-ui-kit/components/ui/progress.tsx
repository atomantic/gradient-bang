  ...
  [&>[data-slot=progress-indicator]]:absolute [&>[data-slot=progress-indicator]]:top-0 [&>[data-slot=progress-indicator]]:left-0 [&>[data-slot=progress-indicator]]:bottom-0 [&>[data-slot=progress-indicator]]:w-[var(--progress-width)]`,
  {
    variants: {
      ...
      color: {
        ...
        secondary: "bg-secondary/20 [&>[data-slot=progress-indicator]]:bg-secondary",
        ...
        inactive: "bg-inactive/20 [&>[data-slot=progress-indicator]]:bg-inactive",
  ...
  return (
    ...
    >
      <ProgressPrimitive.Indicator
        ...
        style={{ "--progress-width": `${percent || 0}%` } as React.CSSProperties}
      />
    </ProgressPrimitive.Root>
  )
})
