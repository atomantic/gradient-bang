...
export const ButtonPrimary: Story<ButtonProps> = ({ ...props }) => (
  <div className="ladle-section-container">
    ...
    <p>
      Buttons can accept a <code>state</code> prop that overrides the variant colors. This is useful
      when working with devices and mute states, where you want to keep a particular variant but
      change the color to match the state.
    </p>
    <section className="ladle-section">
