...
import { PipecatAppBase, type PipecatBaseChildProps } from "@/components/PipecatAppBase"
import { Button, Card, CardContent, Divider, ErrorCard, Input, SpinLoader } from "@/components/ui"
...
export const WidgetTemplate: React.FC<WidgetTemplateProps> = memo(
  ({ classNames, toggleButtonLabel = "Open", connectParams, ...rest }) => {
    ...
    return (
      <div className={cn("relative flex flex-col gap-4", classNames?.container)}>
        {isOpen && widgetComp}
