...
import { type CanvasWaveformOptions, CircularWaveformCanvas, WaveformState } from "./canvas"
...
export const CircularWaveform: React.FC<CircularWaveformProps> = ({
  ...
  const determineState = useCallback((): WaveformState => {
    const newState =
      isThinking ? WaveformState.THINKING
      : audioTrack ? WaveformState.AUDIO
      : WaveformState.IDLE
  ...
  }, [color1, color2, backgroundColor, sensitivity, rotationEnabled, numBars, barWidth, debug])
