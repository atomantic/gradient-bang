...
const RadiusItem = ({ children, className }: { children: React.ReactNode; className?: string }) => (
  <div
    className={cn(
...
export const Radius: Story = () => (
  <div className="flex flex-col gap-6">
    ...
    <p>
      ...
      <code>0.375rem (6px)</code>. This allows you to override the radius for all elements by
      setting <code>--radius-base</code> in your theme.
    </p>
    <p>
    ...
    <hr />
    <p>
      By default, components will render a border radius by following a particular order of
      precedence:
      <ul>
        <li>
          Automatically set based on the <code>size</code> property of the component
        </li>
        <li>
    ...
    <p>
      This approach allows for less verbose code (i.e. not requiring you to specify the radius for
      every component), while still allowing you to override in specific cases.
    </p>
    <p>
      For example, <code>Button size="xl"</code> will render a button with a border radius of
      <code>var(--radius-xl)</code> by default, but can be overridden to
      <code>var(--radius-sm)</code> by setting the <code>rounded</code>
      property to <code>sm</code> e.g. <code>Button size="xl" rounded="sm"</code>.
    </p>
    <p>
