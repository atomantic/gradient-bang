...
const SizingItem = ({ children, className }: { children: React.ReactNode; className?: string }) => (
  <div
    className={cn(
...
export const ButtonSizing: Story = () => (
  <div className="ladle-section-container">
    <p>
      Multiple primitives are sized to the same dimensions as the button primitive, supporting the{" "}
      <code>size</code> prop.
    </p>
    <p>
    ...
    <p>
      For buttons where <code>isIcon</code> is <code>true</code>, the icon is sized using the{" "}
      <code>button-icon-*</code> utility.
    </p>
    <section className="ladle-section">
    ...
    <p>
      Direct descendants of a button that contain an SVG icon will adjust the gap and padding to
      center the icon more aesthetically.
    </p>
    <section className="ladle-section">
