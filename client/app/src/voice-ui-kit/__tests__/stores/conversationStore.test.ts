...
describe("conversationStore", () => {
  ...
  describe("updateAssistantBotOutput (unspoken)", () => {
    ...
    it("creates new part for sentence-level chunks", () => {
      ...
      getState().updateAssistantBotOutput("First sentence.", true, false, "sentence")
      getState().updateAssistantBotOutput("Second sentence.", true, false, "sentence")
    ...
    it("creates new part for custom aggregation types", () => {
      ...
      getState().updateAssistantBotOutput("Some text", false, false, "sentence")
      getState().updateAssistantBotOutput("console.log('hi')", false, false, "code")
