  ...
  parameters: {
    ...
    properties: {
      ...
      situation: {
        type: "string",
        description:
          "ONE terse sentence (≤20 words) describing the CURRENT state before " +
          "you act: your fighters/shields, the opponents, the threat level. " +
          "Factual, no decision yet.",
      },
      reasoning: {
        type: "string",
        description:
          "ONE terse sentence (≤20 words) explaining WHY you're taking this " +
          "specific action given `situation`. The decision justification.",
      },
    },
    required: ["combat_id", "action", "situation", "reasoning"],
  },
}
